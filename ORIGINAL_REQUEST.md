...
## Follow-up — 2026-05-25T12:32:29Z
...
## Follow-up — 2026-05-25T12:36:24Z

The pricing model has been expanded to include a sliding scale / fleet discount pricing model for multi-passport signups to increase volume sales:
...
This should be implemented on the `/pricing` page and highlighted in product copywriting.

Additionally, the P2P transfer modal, states, and update handlers have been manually implemented inside `src/app/dash/page.tsx`, which is highly polished and verified! Ensure this manual code is integrated into E2E verification tests.

## Follow-up — 2026-05-25T12:41:57Z

The pricing plan is further simplified to completely remove the flat B2B pricing plan ($49/mo) and place business users (dealerships, repair shops) directly on the unified per-tag sliding scale:
- Zero Flat B2B Base Fees: Free signup for everyone.
- Dynamic Volume Billing: Dealerships and fleets pay dynamically based on the number of active tags they own (falling into the $0.99/mo tier for 10+ active tags).
...
This must be implemented on the `/pricing` page and in product copywriting.

## Follow-up — 2026-05-25T12:43:26Z

Add dynamic and re-routable on the fly physical QR code capabilities to product copywriting and FAQs on the `/pricing` and landing pages:
...
- Highly Flexible Redirection: Frame the Gridpass card as a permanent, flexible dynamic redirection asset!

## Follow-up — 2026-05-25T12:44:07Z

Highlight the ultimate physical growth vector: **Scan-to-Activate Bulk Decal Distribution** in the marketing, landing pages, and FAQs:
- Bulk Decal Distribution: Organizers and users can print rolls of unassigned, generic QR code stickers and hand them out at meets/shows/racetracks.
- 30-Second Onboarding: When scanned, the `/join?id=xxx` landing flow dynamically guides them through a 30-second registration, registers their vehicle inline, and instantly activates the tag and $1.99/mo subscription.
- Organic Growth Loop: Explain how this creates a high-velocity organic onboarding loop for clubs and organizations.

## Follow-up — 2026-05-25T12:46:22Z

Integrate low-friction, everyday purchase price comparisons into the subscription descriptions and pricing details on the `/pricing` page and landing banners:
- Cup of coffee/Monster drink: *"Less than the price of a cup of coffee or a Monster Energy drink per month..."*
- Single gallon of gas: *"Literally half the price of a single gallon of gas to give your rig a permanent, verified digital identity."*
- Everyday Purchases: Ground the $1.99/mo subscription cost in everyday minor purchases to make checkout conversion extremely high.

## Follow-up — 2026-05-25T12:51:30Z

The brand aesthetic, theme, and logo must align exactly with the physical invite/badge card:
- Premium Brand Logo component: A sharp custom SVG-based reusable component `src/components/Logo.tsx` rendering a high-contrast mountain peak, winding curvy asphalt racetrack, and a red-and-white striped curbing line matching the physical badge logo. Styles "GRID" in bold white/silver and "PASS" in racing crimson/red (`#bd2925`).
- Reusable Integration: All raw text "GRIDPASS" or other static logos across pages must be replaced with the custom `@/components/Logo` brand icon.
- Carbon & Crimson Aesthetic: Use racing crimson/blood red (`#bd2925` / HSL matching) for primary borders, text-gradient highlights, or dashboard cards where appropriate to give the app a cohesive, high-performance racing carbon-and-crimson aesthetic.

The developers must make sure that all changes compile flawlessly and E2E browser tests pass cleanly.

## Follow-up — 2026-05-25T23:29:24Z

The user has provided the final simplifications before we go live:
1. **Remove /adventure (Voyage AI) link completely**: We have removed it from Navbar.tsx and Footer.tsx. Ensure no pages, copywriting, or navigation bars link to `/adventure` or mention the "Voyage" thing.
