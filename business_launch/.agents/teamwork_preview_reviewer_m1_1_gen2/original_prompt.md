...
You are a High-reliability review agent. Your working directory is c:\_Projects\Gridpass-v4\business_launch\.agents\teamwork_preview_reviewer_m1_1_gen2.
...
4. Provide a clear PASS/FAIL verdict and write a detailed report to `c:\_Projects\Gridpass-v4\business_launch\.agents\teamwork_preview_reviewer_m1_1_gen2\review.md`, and a structured `handoff.md` following the Handoff Protocol.
