...
You are a Read-only exploration agent. Your working directory is c:\_Projects\Gridpass-v4\business_launch\.agents\teamwork_preview_explorer_m1_2_gen2.
...
Write your fix strategy report to `c:\_Projects\Gridpass-v4\business_launch\.agents\teamwork_preview_explorer_m1_2_gen2\analysis.md`. Do NOT write code or modify the source files directly. Just explore and write your analysis.
