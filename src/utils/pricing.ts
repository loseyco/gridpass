...
export function calculateFounderPrice(soldCount: number): number {
    ...
    if (spotNumber <= PRICING_CONSTANTS.PHASE_1_LIMIT) {
        return spotNumber * PRICING_CONSTANTS.PHASE_1_INCREMENT;
    }

    // Phase 2: 26-50
    if (spotNumber <= PRICING_CONSTANTS.PHASE_2_LIMIT) {
        const phase1Max = PRICING_CONSTANTS.PHASE_1_LIMIT * PRICING_CONSTANTS.PHASE_1_INCREMENT; // $50
    ...
    // Phase 3: 51-100
    const phase1Max = PRICING_CONSTANTS.PHASE_1_LIMIT * PRICING_CONSTANTS.PHASE_1_INCREMENT; // $50
    const phase2Max = phase1Max + ((PRICING_CONSTANTS.PHASE_2_LIMIT - PRICING_CONSTANTS.PHASE_1_LIMIT) * PRICING_CONSTANTS.PHASE_2_INCREMENT); // $50 + (25 * 18) = $50 + 450 = $500
