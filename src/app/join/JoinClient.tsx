        ...
        <main className="min-h-screen bg-[#060608] text-[#f4f4f7] py-12 px-4 relative overflow-hidden flex flex-col justify-center items-center">
          ...
          <div className="w-full max-w-md space-y-6 relative z-10">
            ...
            <div className="glass-card p-6 rounded-3xl border-4 border-emerald-500/40 bg-neutral-950/90 animate-border-flash space-y-6 text-center">
              ...
              {/* Geofence notice */}
              <p className="text-[10px] text-neutral-355 font-semibold leading-relaxed">
            ...
            <Link href="/dash" className="text-xs font-mono text-neutral-500 hover:text-neutral-355 font-bold transition-colors block text-center uppercase tracking-wider">
              ← Back to Dashboard
            </Link>
        ...
        return (
            <main className="min-h-screen bg-[#060608] flex flex-col items-center justify-center p-6 relative overflow-hidden">
                ...
                <div className="w-full max-w-md text-center space-y-6 relative z-10">
                    ...
                    {tagId && (
                        <div className="p-3 bg-neutral-900/60 border border-neutral-955 rounded-xl font-mono text-[10px] text-neutral-505 truncate">
                            Routing tag: {tagId}
                        </div>
                    )}
                </div>
                    ...
                    <div className="glass-card p-6 rounded-3xl">
                        <form onSubmit={handleManualSubmit} className="space-y-4">
                            <input
                                ...
                                className="glass-input w-full text-center px-4 py-3 rounded-xl font-mono text-lg tracking-widest placeholder:text-neutral-700 font-bold bg-neutral-900 border border-neutral-800 text-white"
                            />
                            <button
                                type="submit"
                        ...
                        <div className="glass-card p-8 rounded-3xl text-center space-y-6 border-red-500/20">
                            ...
                            <div className="space-y-2">
                                ...
                                {unclaimedVehicle.partner_dealer && (
                                    <p className="text-xs font-bold text-neutral-505 uppercase tracking-wide">
                            ...
                            {!user ? (
                                ...
                                <div className="flex flex-col gap-3 pt-2">
                                    ...
                                    <button
                                        ...
                                        className="text-xs text-neutral-500 hover:text-neutral-350 font-bold transition-colors pt-2 uppercase tracking-wider"
                                    >
                        ...
                        {!user ? (
                            <div className="space-y-6">
                                <div className="glass-card p-8 rounded-3xl text-center space-y-6 border-yellow-500/15">
                                    <div className="w-14 h-14 bg-yellow-500/10 border border-yellow-500/20 rounded-2xl flex items-center justify-center text-yellow-505 mx-auto">
