...
const DEFAULT_AGENTS: AgentStaff[] = [
  ...
  },
  {
    ...
    title: 'Cash Flow, B2B Pricing & MRR/ARR Models',
    icon: '💰',
    ...
    tickets_completed: 1,
    sops_count: 1,
    system_prompt: 'Cash flow, MRR/ARR models, B2B deal pipelines, pricing packages, LTV/CAC calculations.',
  },
  {
    id: 'traffic_expert',
    name: 'Traffic & Analytics Specialist',
    role_code: 'traffic_expert',
    title: 'Real-Time Scans & Entry/Exit Flow Telemetry',
    icon: '📊',
    category: 'Analytics',
    status: 'ACTIVE',
    llm_model: 'Gemini 2.0 Flash',
    ...
    tickets_completed: 1,
    sops_count: 1,
    system_prompt: 'Real-time traffic flows, entry/exit paths, physical QR scan velocity, viewport distributions.',
  },
  {
    id: 'git_expert',
    name: 'Git & Release Coordinator',
    role_code: 'git_expert',
    title: 'Clean Commits & GitHub Synchronization',
    icon: '🔀',
    category: 'DevOps & Git',
    status: 'ACTIVE',
    llm_model: 'Claude 3.5 Sonnet',
  ...
  },
  {
    ...
    role_code: 'tester',
    title: 'Playwright Browser E2E & Auth Sessions',
    icon: '🧪',
    category: 'QA & Testing',
    status: 'ACTIVE',
    llm_model: 'Claude 3.5 Sonnet',
