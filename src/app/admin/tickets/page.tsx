...
const DEFAULT_AGENT_TICKETS: AgentTicket[] = [
  {
    ...
    resolution_summary: 'Created execution ticket for 1-tap SMS group chat invite buttons and 9:16 Instagram Story canvas graphic downloads.',
  ...
  },
  {
    ...
    files_modified: ['src/app/events/[id]/page.tsx', 'src/lib/types/events.ts'],
    schema_changes: ['staging_class: PEV / Micro-Mobility', 'battery_wh', 'motor_watts'],
    ...
    resolution_summary: 'Created execution ticket for PEV micro-mobility staging classes and dynamic electric battery/motor spec inputs.',
    verification_proof: 'Pending implementation on localhost.',
    sop_summary: 'SOP for PEV staging class integration and battery metrics.',
    sop_steps: [
      'Add PEV / Micro-Mobility to default event staging class dropdowns.',
      'Render dynamic battery Wh, voltage, and motor wattage inputs for electric vehicles.'
    ],
    created_at: new Date().toISOString().split('T')[0],
  ...
  },
  {
    ...
    resolution_summary: 'Created execution ticket for live food truck menus, express mobile pickup ordering, and automatic 10% platform transaction fee split.',
    verification_proof: 'Pending implementation on localhost.',
