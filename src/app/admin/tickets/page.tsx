...
const DEFAULT_AGENT_TICKETS: AgentTicket[] = [
  {
    ...
    title: 'GridPass SRCommander: Standalone Native Windows App, 4-Tab Comms Deck & Zero Fake Data Compliance',
    category: 'feature',
    status: 'VERIFIED',
    priority: 'urgent',
    components_used: [
    ...
    files_modified: [
      'src/app/srcommander/comms/page.tsx (Purged all fake/simulated data; strict raw WebSocket & Firestore listener evaluation)',
      'scripts/gridpass_desktop_app.py (Native Windows Desktop Application window using WebView2/pywebview)',
      'Launch_GridPass_Desktop_App.bat (1-Click Windows Desktop Launcher)',
    ...
    schema_changes: [
      ...
      'Purged all synthetic simulated data generators and bound all telemetry strictly to live PyIRSDK / WebSocket stream and Cloud Firestore paddock_messages',
      'Created standalone native Windows desktop app via scripts/gridpass_desktop_app.py and packaged 1-click launcher Launch_GridPass_Desktop_App.bat'
    ],
    issue_description: 'Sim racers and league stewards required a native desktop command center interface adhering strictly to GridPass White/Red/Charcoal aesthetic with 4 unified operational decks (low-latency paddock voice/radio comms, 60 FPS cockpit telemetry & tachometer HUD, hardware rig peripheral controls, and broadcast studio controls) without any fake or simulated data fallback.',
    root_cause: 'Lack of an integrated standalone desktop application wrapper and presence of synthetic simulated fallback data in the comms and telemetry decks instead of strictly evaluating live WebSocket / PyIRSDK and Firestore streams.',
    resolution_summary: 'Stripped 100% of mock/fake fallback data from /srcommander/comms and bound all telemetry strictly to live PyIRSDK/WebSocket state and Cloud Firestore paddock_messages. Created standalone native Windows desktop application (scripts/gridpass_desktop_app.py) running via Edge WebView2 Evergreen runtime and packaged 1-click launcher Launch_GridPass_Desktop_App.bat.',
    verification_proof: 'Playwright headed visual test passed 100% (1/1 passed). Verified 4 operational decks and live telemetry listener behavior.',
    sop_summary: 'SOP for operating the SRCommander Desktop Command Center and Comms Deck.',
    sop_steps: [
      '1. Launch GridPass Desktop App via Launch_GridPass_Desktop_App.bat or navigate to /srcommander/comms.',
      ...
      '4. Monitor 60 FPS live PyIRSDK telemetry, test wind/LED hardware, or trigger instant broadcast replay bookmarks.'
    ],
    created_at: '2026-08-31T22:30:00Z',
    completed_at: '2026-08-31T22:42:00Z',
    verified_at: '2026-08-31T22:42:00Z'
  },
  {
