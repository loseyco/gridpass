      ...
      <section className="relative max-w-7xl mx-auto px-6 py-12 flex-1 z-10 w-full space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="glass-card p-6 sm:p-8 rounded-3xl space-y-5 border-neutral-800 relative group overflow-hidden">
            ...
            <div className="h-12 w-12 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-450">
          ...
          <div className="glass-card p-6 sm:p-8 rounded-3xl space-y-5 border-neutral-800 relative group overflow-hidden">
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-black text-white group-hover:text-emerald-405 transition-colors">Digital Vehicle Garages</h3>
              <p className="text-xs text-neutral-400 leading-relaxed font-medium">
                ...
                <div className="w-full max-w-sm bg-[#040406] border border-neutral-900 rounded-3xl p-6 relative overflow-hidden shadow-2xl space-y-6">
                  ...
                  <div className="flex items-center justify-between border-b border-neutral-900/60 pb-4">
                    <div className="flex items-center gap-3">
                      <div className="h-9 w-9 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-450">
                    ...
                    <span className="text-[9px] font-bold bg-emerald-500/10 text-emerald-450 border border-emerald-500/20 px-2 py-0.5 rounded">ACTIVE PASSPORT</span>
                  </div>
                ...
                <div className="w-full max-w-sm bg-[#040406] border border-neutral-900 rounded-3xl p-6 relative overflow-hidden shadow-2xl space-y-6">
                  ...
                  <div className="bg-neutral-950/80 border border-neutral-900 rounded-2xl p-4 font-mono text-[11px] leading-relaxed text-indigo-300 space-y-2.5 shadow-inner">
                    ...
                    <div className="flex justify-between border-b border-neutral-900 pb-1.5">
                      ...
                      <span className="text-emerald-405 font-bold">SIGNED (VERIFIED)</span>
                    </div>
                    <div className="flex justify-between border-b border-neutral-900 pb-1.5">
                    ...
                    <div className="flex justify-between pt-1">
                      ...
                      <span className="text-emerald-405 font-bold">$27.00 Track / $2.99 Fee</span>
                    </div>
                  </div>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-3.5">
                    <div className="flex items-start gap-3">
                      <div className="h-5 w-5 bg-neutral-900 border border-neutral-800 rounded-full flex items-center justify-center text-blue-450 shrink-0 font-bold text-xs">
                        ✓
                      </div>
              ...
              {activeSegment === 'swarm' && (
                <div className="space-y-5">
                  ...
                  <div className="space-y-3.5">
                    <div className="flex items-start gap-3">
                      <div className="h-5 w-5 bg-neutral-900 border border-neutral-800 rounded-full flex items-center justify-center text-cyan-405 shrink-0 font-bold text-xs">
                        ✓
                      </div>
                      <div className="text-xs text-neutral-300">
