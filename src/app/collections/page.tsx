...
export const metadata = {
    title: 'Collections | GridPass',
    description: 'Manage your automotive collections and fleets.',
};

export default async function CollectionsPage() {
    // We could call getCollections directly since it uses createClient internally 
    // but better to keep data fetching patterns consistent.
            ...
            <div className="relative bg-neutral-900 border-b border-neutral-800 pt-24 pb-12 px-6 sm:px-12">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6">
                    <div>
                        ...
                        <p className="text-neutral-400 max-w-xl text-lg">
                            Manage portfolios, fleets, and museum exhibits.
                        </p>
                    </div>
                    <Link
                ...
                <div className="mt-8">
                    <Link
                        ...
                        className="text-neutral-400 hover:text-white text-sm flex items-center gap-2 transition-colors border-b border-transparent hover:border-neutral-500 pb-0.5 w-fit"
                    >
                        <Globe className="w-4 h-4" />
                        Browsing other collections? View Public Gallery &rarr;
                    </Link>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-12 py-12">
                {collections.length === 0 ? (
                    <EmptyState
                        ...
                        description="Create a collection to organize your vehicles for a team, museum, or private portfolio."
